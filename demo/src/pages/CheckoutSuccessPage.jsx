...
export default function CheckoutSuccessPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Order Success | TechMotiveSupreme</title>
        <meta name="description" content="Your payment was successful! View your order details and next steps for your project." />
        <meta property="og:title" content="Order Success | TechMotiveSupreme" />
        <meta property="og:description" content="Your payment was successful! View your order details and next steps." />
